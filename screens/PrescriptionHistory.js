...
export default function PatientHistory({ navigation, route }) {
  ...
  const renderItem = (item, index) => {
    ...
    const patientName = item.patient_information.name ? item.patient_information.name : NA;
    const patientWeight = item.patient_information.weight ? item.patient_information.weight : NA;
    const patientAge = item.patient_information.age ? item.patient_information.age : NA;
    const patientHeight = item.patient_information.height ? item.patient_information.height : NA;
    const patientGender = item.patient_information.gender ? item.patient_information.gender : NA;
