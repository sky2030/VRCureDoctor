          ...
          <View style={styles.title1}>
            ...
            <View style={styles.title9}>
              <Text style={styles.bodytext}>
                ...
                webpage shall manage your use of our website, Application Name
                accessible at doctors.mconnecthealth.com.
              </Text>
              {/* <Text style={styles.bodytext}>
          ...
          <View style={styles.title1}>
            ...
            <View style={styles.title9}>
              <Text style={styles.bodytext}>
                ...
                Application. By using this Application, you agreed to accept all terms
                and conditions written in here. You must not use this Application if
                you disagree with any of these Application Standard Terms and
                Conditions.
              </Text>
              {/* <Text style={styles.bodytext}>
          ...
          <View style={styles.title1}>
            ...
            <View style={styles.title9}>
              <Text style={styles.bodytext}>
                ...
                and materials contained in this Application.
              </Text>
              <Text style={styles.bodytext}>
                You are granted limited license only for purposes of viewing the
                material contained on this Application.
              </Text>
              {/* <Text style={styles.bodytext}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.title1}>
            ...
            <View style={styles.title9}>
              ...
              <Text style={styles.bodytext}>
                publishing any Application material in any other media; selling,
                sublicensing and/or otherwise commercializing any Application
                material; publicly performing and/or showing any Application
                material; using this Application in any way that is or may be
                damaging to this Application; using this Application in any way that
                impacts user access to this Application; using this Application contrary
                to applicable laws and regulations, or in any way may cause harm
                to the Application, or to any person or business entity; engaging in
                any data mining, data harvesting, data extracting or any other
                similar activity in relation to this Application; using this Application
                to engage in any advertising or marketing. Certain areas of this
                Application are restricted from being access by you and Company Name
                may further restrict access by you to any areas of this Application,
                at any time, in absolute discretion. Any user ID and password
                you may have for this Application are confidential and you must
          ...
          <View style={styles.title1}>
            ...
            <View style={styles.title9}>
              <Text style={styles.bodytext}>
                ...
                and you in relation to your use of this Application, and supersede
